...
> **主线：7.5 Alpha Hardening ← 当前（7.5-D .planseed）→ 8.0 Solver 2.0**（7.5-C ✅ · 7.5-B ✅ · 7.5-A ✅ · 7.2 ✅ · 7.1.1 Print ☐）  
...
| **7.5** | **Alpha Engineering Hardening** | **← 当前**（7.5-D .planseed；7.5-A/B/C ✅） |
...
7.5       Alpha Engineering Hardening       ← 当前（7.5-D；7.5-A/B/C ✅）
8.0       Solver Diversity / Solver 2.0     ← 后续
8.x       Advanced Site / Code / Interop    ← 更后
```
...
| **当前主线** | **7.5-D** → … → **8.0**（7.5-A/B/C ✅ · 7.2 ✅ · Phase 6 冻结 · 7.1.1 Print ☐） |

...
> **主线：8.0 Solver 2.0 ← 当前（8.1 ✅ · 下一 8.2 Pareto）· 7.5 ✅ · 7.2 ✅ · 7.1.1 Print ☐**  
...
| **8.0** | **Solver Diversity / Solver 2.0** | **← 当前**（8.1 ✅；见 [phases/phase-8-solver-2.0.md](phases/phase-8-solver-2.0.md)） |
...
7.5       Alpha Engineering Hardening       ✅（A–I）
8.0       Solver Diversity / Solver 2.0     ← 当前（8.1 ✅ · 下一 8.2 Pareto）
8.x       Advanced Site / Code / Interop    ← 更后
```
...
| **8.0** | Solver Diversity / Solver 2.0 | **← 当前**（8.1 ✅；[phases/phase-8-solver-2.0.md](phases/phase-8-solver-2.0.md)） |
| **8.x** | Advanced Site / Code / Interop | 更后 |
...
| **当前主线** | **8.2** Pareto Frontier（8.1 ✅ · 禁止 GA 先行 · 7.1.1 Print ☐） |

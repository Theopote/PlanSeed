...
> **主线：8.0 Solver 2.0 ← 当前（8.2 ✅ · 下一 8.3 CP-SAT）· 7.5 ✅ · 7.2 ✅ · 7.1.1 Print ☐**  
...
| **8.0** | **Solver Diversity / Solver 2.0** | **← 当前**（8.2 ✅；见 [phases/phase-8-solver-2.0.md](phases/phase-8-solver-2.0.md)） |
...
7.5       Alpha Engineering Hardening       ✅（A–I）
8.0       Solver Diversity / Solver 2.0     ← 当前（8.2 ✅ · 下一 8.3 CP-SAT）
8.x       Advanced Site / Code / Interop    ← 更后
```
...
| **8.0** | Solver Diversity / Solver 2.0 | **← 当前**（8.2 ✅；[phases/phase-8-solver-2.0.md](phases/phase-8-solver-2.0.md)） |
| **8.x** | Advanced Site / Code / Interop | 更后 |
...
| **当前主线** | **8.3** CP-SAT Research（8.2 ✅ · 禁止 GA 进化 · 7.1.1 Print ☐） |

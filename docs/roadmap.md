...
> **主线：8.0 Solver 2.0 ← 当前（8.0-A LayoutGenerator）· 7.5 ✅ · 7.2 ✅ · 7.1.1 Print ☐**  
...
| **8.0** | **Solver Diversity / Solver 2.0** | **← 当前**（8.0-A；见 [phases/phase-8-solver-2.0.md](phases/phase-8-solver-2.0.md)） |
...
7.5       Alpha Engineering Hardening       ✅（A–I）
8.0       Solver Diversity / Solver 2.0     ← 当前（8.0-A LayoutGenerator）
8.x       Advanced Site / Code / Interop    ← 更后
```
...
| **8.0** | Solver Diversity / Solver 2.0 | **← 当前**（8.0-A；[phases/phase-8-solver-2.0.md](phases/phase-8-solver-2.0.md)） |
| **8.x** | Advanced Site / Code / Interop | 更后 |
...
| **当前主线** | **8.0-A** → 8.0-B MaxRect（7.5 ✅ · 禁止 GA 先行 · 7.1.1 Print ☐） |

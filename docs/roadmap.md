...
> **主线：7.5 Alpha Hardening ← 当前（7.5-E App hooks）→ 8.0 Solver 2.0**（7.5-D ✅ · 7.5-C ✅ · 7.5-B ✅ · 7.5-A ✅ · 7.2 ✅ · 7.1.1 Print ☐）  
...
| **7.5** | **Alpha Engineering Hardening** | **← 当前**（7.5-E App hooks；7.5-A–D ✅） |
...
7.5       Alpha Engineering Hardening       ← 当前（7.5-E；7.5-A–D ✅）
8.0       Solver Diversity / Solver 2.0     ← 后续
8.x       Advanced Site / Code / Interop    ← 更后
```
...
| **7.1.1** | **Presentation Accuracy & Smoke** | Engineering ✅；Print smoke ☐ |
| **7.2** | **Export Formats** | **✅** |
| **7.5** | **Alpha Engineering Hardening** | **← 当前**（见 [phase-7.5-alpha-hardening.md](phase-7.5-alpha-hardening.md)） |
| **8.0** | **Solver Diversity / Solver 2.0** | **后续** |
| **8.x** | Advanced Site / Code / Interop | **更后** |
| — | SVG Debug | ✅ 开发工具 |
...
### Phase 6.7.2 — Blind Requalification ✅ 工程 PASS / 彻底冻结
...
qualify --gate：git worktree dirty → 直接拒绝（防 baseline SHA ≠ 未提交代码）
```
...
- [x] `qualify --gate`：`git_dirty` → **拒绝**
- [x] **Phase 6 彻底冻结** — 不开 6.7.3+ 抠分；产品主线 → Phase 7.1
...
| **7.5** | Alpha Engineering Hardening | **← 当前**（[phase-7.5-alpha-hardening.md](phase-7.5-alpha-hardening.md)） |
...
| **当前主线** | **7.5-E** → … → **8.0**（7.5-A–D ✅ · 7.2 ✅ · Phase 6 冻结 · 7.1.1 Print ☐） |

...
> **主线：7.5 Alpha Hardening ← 当前（7.5-I privacy/limits/audit）→ 8.0 Solver 2.0**（7.5-A–H ✅ · 7.2 ✅ · 7.1.1 Print ☐）  
...
| **7.5** | **Alpha Engineering Hardening** | **← 当前**（7.5-I；7.5-A–H ✅） |
...
| **当前主线** | **7.5-I** → **8.0**（7.5-A–H ✅ · 7.2 ✅ · Phase 6 冻结 · 7.1.1 Print ☐） |

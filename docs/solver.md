...
├── circulation.py   # 后续
├── orientation.py   # 后续
├── privacy.py       # Phase 3：路径隐私过渡
├── program_fit.py   # Phase 3：Program Fit / Space Efficiency
...
- **下一步**：Phase 3.5 Core Consolidation（sidecar + Compare；见 [phase-3.5-core-consolidation.md](phase-3.5-core-consolidation.md)）
